...
/obj/machinery/photocopier/faxmachine
	...
	icon_state = "fax"
	req_one_access = list(access_fax) //Warden needs to be able to Fax solgov too.
	...
	New()
		...
		component_parts += new /obj/item/weapon/circuitboard/machine/fax_machine(src)
...
/obj/machinery/photocopier/faxmachine/proc/message_admins(var/mob/sender, var/faxname, var/obj/item/sent, var/reply_type, font_colour="#006100")
	var/msg = "<span class='notice'><b><font color='[font_colour]'>[faxname]: </font>[key_name(sender, 1)] (<A HREF='?_src_=holder;adminplayeropts=\ref[sender]'>PP</A>) (<A HREF='?_src_=vars;Vars=\ref[sender]'>VV</A>) (<A HREF='?_src_=holder;subtlemessage=\ref[sender]'>SM</A>) (<a href='?_src_=holder;[reply_type]=\ref[sender];originfax=\ref[src]'>REPLY</a>)</b>: Receiving '[sent.name]' via secure connection ... <a href='?_src_=holder;AdminFaxView=\ref[sent]'>view message</a></span>"
	log_admin(msg)
	for(var/client/C in admins)
		C << msg

/*
 * Design datum and circuitboard
 */
/obj/item/weapon/circuitboard/machine/fax_machine
	name = "fax machine circuit board"
...
/datum/design/circuit/fax_machine
	...
	build_path = /obj/item/weapon/circuitboard/machine/fax_machine